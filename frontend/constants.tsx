...
const ArrowsRightLeftIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const PERMISSIONS_LIST: Permission[] = [
  {
    id: 'read_transaction_history',
    label: 'Analyze Spending Habits',
    description: 'Allow us to review your transaction history to identify spending patterns and suggest budget improvements.',
    icon: DocumentTextIcon,
  },
  {
    id: 'read_debts_history',
    label: 'Debt Management Plan',
    description: 'Let us access your debt information (loans, credit cards) to create a personalized payoff strategy.',
    icon: BanknotesIcon,
  },
  {
    id: 'read_investments_history',
    label: 'Portfolio Optimization',
    description: 'Grant access to your investment history for performance analysis and rebalancing suggestions.',
    icon: ChartBarIcon,
  },
  {
    id: 'read_networth',
    label: 'Track Financial Goals',
    description: 'Allow us to calculate and track your net worth over time to monitor progress towards your goals.',
    icon: ArrowTrendingUpIcon,
  },
  {
    id: 'read_cashflow',
    label: 'Cash Flow Forecasting',
    description: 'Enable analysis of your income and expenses to predict future cash flow.',
    icon: ArrowsRightLeftIcon,
  },
   {
    id: 'book_appointments',
    label: 'Schedule Advisor Meetings',
